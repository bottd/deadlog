...
stats schema=2 method=2 collected="2026-09-21T21:41:20.000Z" {
  before from="2025-02-13" to="2025-02-25"
  after from="2025-02-26" to="2025-03-12"
}
``
...
impact closed=#true {
  all {
    before win=0.4665 pick=0.3987 matches=102502 days=12 total=3085212 covered=12 coverage="complete"
    after win=0.4555 pick=0.3535 matches=115697 days=14 total=3927660 covered=14 coverage="complete"
  }
  high {
    before win=0.5257 pick=0.4832 matches=5302 days=12 total=131664 covered=12 coverage="complete"
    after win=0.4984 pick=0.4326 matches=5690 days=14 total=157824 covered=14 coverage="complete"
  }
}
``
