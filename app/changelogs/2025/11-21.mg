...
``embed:svelte:
<AbilityHeading name="Hyperbeam DPS" />
``
...
``embed:svelte:
<EntityHeading name="Mystic Vulnerability" type="item" />
``
...
``embed:svelte:
<EntityHeading name="Transcendent Cooldown" type="item" />
``
