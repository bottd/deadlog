...
==
==ability:grapple-arm:
[[!:https://assets-bucket.deadlock-api.com/assets-api-res/images/abilities/bebop/bebop_hook.webp]]
### Grapple Arm
...
- No longer has negative base bullet resistance
...
- Bullet Dance no longer grants 60% Evasion
- Bullet Dance duration increased from 3s to 3.5s
- Bullet Dance duration spirit scaling reduced from 0.08 to 0.03
...
[[!:https://assets-bucket.deadlock-api.com/assets-api-res/images/items/weapon/armor_piercing_rounds.webp]]
...
=
=item:plated-armor:
[[!:https://assets-bucket.deadlock-api.com/assets-api-res/images/items/vitality/plated_armor.webp]]
## Plated Armor
...
- Move Speed increased from 1.5m to 1.75m
- Barrier duration increased from 7s to 8s
- Time Frame increased from 3.5s to 4s
=