...
``embed:svelte:
<AbilityHeading name="Call Bell" id="call-bell-1" />
``
...
``embed:svelte:
<AbilityHeading name="Djinn's Mark" id="djinn-s-mark-1" />
``
...
``embed:svelte:
<AbilityHeading name="Traveler" id="traveler-1" />
``
...
``embed:svelte:
<AbilityHeading name="Combo" id="combo-1" />
``
...
``embed:svelte:
<AbilityHeading name="Goo Ball" id="goo-ball-1" />
``
