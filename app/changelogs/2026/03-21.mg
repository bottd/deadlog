...
``embed:svelte:
<SectionPreview type="hero" names={["Abrams", "Apollo", "Billy", "Calico", "Celeste", "Doorman", "Dynamo", "Graves", "Infernus", "Ivy", "Kelvin", "McGinnis", "Mina", "Mirage", "Mo &amp; Krill", "Shiv", "Silver", "Victor", "Viscous", "Wraith", "Yamato"]} />
``
...
``embed:svelte:
<SectionPreview type="item" names={["Arcane Surge", "Ballistic Enchantment", "Blood Tribute", "Boundless Spirit", "Burst Fire", "Celestial Blessing", "Cloak of Opportunity", "Counterspell", "Cultist Sacrifice", "Divine Barrier", "Echo Shard", "Electric Slippers", "Enchanter's Emblem", "Golden Goose Egg", "Greater Expansion", "Guardian Ward", "Healing Nova", "Infinite Rounds", "Knockdown", "Metal Skin", "Mystical Piano", "Nullification Burst", "Rescue Beam", "Restorative Locket", "Seraphim Wings", "Shadow Strike", "Shrink Ray", "Spirit Burn", "Unstable Concoction", "Vortex Web", "Weighted Shots"]} />
``
