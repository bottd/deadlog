...
var ie = {
	...
	ae = [
		...
		{ level: 3, title: `Hook Speed`, id: `hook-speed` },
		{ level: 3, title: `Hook Return Speed`, id: `hook-return-speed` },
		...
		{ level: 3, title: `Mini Turret Health`, id: `mini-turret-health` },
		...
		{ level: 3, title: `Shadow Explosion`, id: `shadow-explosion-1` },
	...
	se = e(
		`<!> <!> <!> <div><!> <div><!> <ul><li><!> <!></li> <li></li></ul> <!></div> <div><!> <!></div> <div><!> <!></div> <div><!> <!></div></div> <div><!> <div><!> <ul><li><!> <!></li></ul> <!></div> <div><!> <!></div></div> <div><!> <div><!> <!></div></div> <!> <div><!> <div><!> <ul><li><!> <!></li></ul> <!></div></div> <div><!> <div><!> <!></div></div> <div><!> <div><!> <ul><li></li> <li><!> <!></li> <li></li> <li></li></ul> <!></div> <!> <div><!> <!></div></div> <div><!> <div><!> <!></div> <div><!> <!></div> <div><!> <!></div> <div><!> <!></div></div> <div><!> <div><!> <ul><li><!> <!></li> <li></li></ul> <!></div> <div><!> <!></div> <div><!> <!></div></div> <div><!> <div><!> <!></div> <div><!> <!></div></div> <div><!> <div><!> <!></div></div> <div><!> <div><!> <!></div></div> <div><!> <div><!> <ul><li><!> <!></li></ul> <!></div></div> <div><!> <div><!> <ul><li><!> <!></li></ul> <!></div> <div><!> <!></div> <div><!> <ul><li><!> <!></li></ul> <!></div> <div><!> <!></div> <div><!> <!></div></div> <!> <!> <div><!> <!></div> <div><!> <!></div> <div><!> <ul><li><!> <!></li> <li></li></ul> <!></div> <div><!> <!></div> <div><!> <!></div> <div><!> <!></div> <div><!> <!></div> <div><!> <!></div> <div><!> <ul><li><!> <!></li> <li></li></ul> <!></div> <div><!> <ul><li></li> <li><!> <!></li></ul> <!></div> <div><!> <ul><li><!> <!></li></ul> <!></div> <div><!> <!></div> <div><!> <!></div> <div><!> <ul><li></li> <li><!> <!></li></ul> <!></div> <div><!> <ul><li></li> <li><!> <!></li></ul> <!></div> <div><!> <!></div> <div><!> <!></div> <div><!> <ul><li><!> <!></li></ul> <!></div> <div><!> <!></div> <div><!> <!></div> <div><!> <!></div> <div><!> <!></div> <div><!> <!></div>`,
		1
	);
function l(e) {
	var c = se(),
...
`
	...
	var ue = a(le, 2),
		de = i(ue),
		fe = i(de);
	n(fe, () => `Hook cooldown reduced from 27s to 22s`);
	var pe = a(fe, 2);
	(s(pe, {
		kind: `hero`,
		name: `Bebop`,
		...
		t(de));
	var me = a(de, 2);
	(n(me, () => `Hook T3 reduced from -15s to -12s Cooldown`, !0), t(me), t(ue));
	var he = a(ue, 2);
	(o(he, { kind: `hero`, name: `Bebop`, ability: `Hook` }), t(u));
	var d = a(u, 2);
	r(d, 1, `ability hook-speed`);
	var ge = i(d);
	n(
		ge,
		() => `
...
`
	...
	var _e = a(ge, 2);
	(o(_e, { kind: `hero`, name: `Bebop`, ability: `Hook Speed` }), t(d));
	var f = a(d, 2);
	r(f, 1, `ability hook-return-speed`);
	var ve = i(f);
	n(
		ve,
		() => `
...
`
	...
	var ye = a(ve, 2);
	(o(ye, { kind: `hero`, name: `Bebop`, ability: `Hook Return Speed` }), t(f));
	var be = a(f, 2);
	r(be, 1, `ability hyper-beam-dps`);
	var xe = i(be);
	n(
		xe,
		() => `
...
`
	...
	var Se = a(xe, 2);
	(o(Se, { kind: `hero`, name: `Bebop`, ability: `Hyper Beam DPS` }), t(be), t(l));
	var p = a(l, 2);
...
`
	...
	var Te = a(we, 2),
		Ee = i(Te),
		De = i(Ee);
	n(De, () => `Charged Shot damage increased from 105 to 115`);
	var Oe = a(De, 2);
	(s(Oe, {
		kind: `hero`,
		name: `Grey Talon`,
		...
		t(Te));
	var ke = a(Te, 2);
	(o(ke, { kind: `hero`, name: `Grey Talon`, ability: `Charged Shot` }), t(m));
	var Ae = a(m, 2);
	r(Ae, 1, `ability rain-of-arrows`);
	var je = i(Ae);
	n(
		je,
		() => `
...
`
	...
	var Me = a(je, 2);
	(o(Me, { kind: `hero`, name: `Grey Talon`, ability: `Rain of Arrows` }), t(Ae), t(p));
	var h = a(p, 2);
	r(h, 1, `hero infernus`);
	var Ne = i(h);
	n(
...
`
	...
	var Ie = a(Fe, 2);
	(o(Ie, { kind: `hero`, name: `Infernus`, ability: `Afterburn` }), t(Pe), t(h));
	var Le = a(h, 2);
	n(
		Le,
		() => `
...
`
	...
	var Ve = a(Be, 2),
		He = i(Ve),
		Ue = i(He);
	n(Ue, () => `Frost Grenade cooldown reduced from 30s to 26s`);
	var We = a(Ue, 2);
	(s(We, {
		kind: `hero`,
		name: `Kelvin`,
		...
		t(Ve));
	var Ge = a(Ve, 2);
	(o(Ge, { kind: `hero`, name: `Kelvin`, ability: `Frost Grenade` }), t(ze), t(g));
	var _ = a(g, 2);
	r(_, 1, `hero lady-geist`);
	var Ke = i(_);
	n(
		Ke,
		() => `
...
`
	...
	var Ye = a(Je, 2);
	(o(Ye, { kind: `hero`, name: `Lady Geist`, ability: `Malice` }), t(qe), t(_));
	var v = a(_, 2);
	r(v, 1, `hero lash`);
	var Xe = i(v);
	n(
...
`
	...
	var et = a($e, 2),
		tt = i(et);
	n(tt, () => `Ground Strike radius reduced from 16m to 14m`);
	var nt = a(tt, 2);
	(s(nt, {
		kind: `hero`,
		name: `Lash`,
	...
	(n(
		...
		t(rt));
	var it = a(rt, 2);
	(n(it, () => `Ground Strike T3 reduced from +100% to +85%`, !0), t(it), t(Qe));
	var at = a(Qe, 2);
	(o(at, { kind: `hero`, name: `Lash`, ability: `Ground Strike` }), t(y));
	var ot = a(y, 2);
	n(
		ot,
		() => `
...
`
	...
	var lt = a(ct, 2);
	(o(lt, { kind: `hero`, name: `Lash`, ability: `Death Slam` }), t(st), t(v));
	var b = a(v, 2);
	r(b, 1, `hero mcginnis`);
	var ut = i(b);
	n(
...
`
	...
	var x = a(ut, 2);
	r(x, 1, `ability mini-turret-spirit-resistance`);
	var dt = i(x);
	n(
		dt,
		() => `
...
`
	...
	var ft = a(dt, 2);
	(o(ft, { kind: `hero`, name: `McGinnis`, ability: `Mini Turret Spirit Resistance` }),
		t(x));
	var S = a(x, 2);
	r(S, 1, `ability mini-turret-health`);
	var pt = i(S);
	n(
		pt,
		() => `
...
`
	...
	var mt = a(pt, 2);
	(o(mt, { kind: `hero`, name: `McGinnis`, ability: `Mini Turret Health` }), t(S));
	var C = a(S, 2);
	r(C, 1, `ability mini-turret`);
	var ht = i(C);
	n(
		ht,
		() => `
...
`
	...
	var gt = a(ht, 2);
	(o(gt, { kind: `hero`, name: `McGinnis`, ability: `Mini Turret` }), t(C));
	var _t = a(C, 2);
	r(_t, 1, `ability heavy-barrage`);
	var vt = i(_t);
	n(
		vt,
		() => `
...
`
	...
	var yt = a(vt, 2);
	(o(yt, { kind: `hero`, name: `McGinnis`, ability: `Heavy Barrage` }), t(_t), t(b));
	var w = a(b, 2);
	r(w, 1, `hero mo-krill`);
	var bt = i(w);
	n(
...
`
	...
	var St = a(xt, 2),
		Ct = i(St),
		wt = i(Ct);
	n(wt, () => `Scorn damage increased from 40 to 50`);
	var Tt = a(wt, 2);
	(s(Tt, {
		kind: `hero`,
		name: `Mo & Krill`,
		...
		t(Ct));
	var Et = a(Ct, 2);
	(n(Et, () => `Scorn T3 debuff duration increased from 10s to 16s`, !0), t(Et), t(St));
	var Dt = a(St, 2);
	(o(Dt, { kind: `hero`, name: `Mo & Krill`, ability: `Scorn` }), t(T));
	var E = a(T, 2);
	r(E, 1, `ability sand-blast`);
	var Ot = i(E);
	n(
		Ot,
		() => `
...
`
	...
	var kt = a(Ot, 2);
	(o(kt, { kind: `hero`, name: `Mo & Krill`, ability: `Sand Blast` }), t(E));
	var At = a(E, 2);
	r(At, 1, `ability combo`);
	var jt = i(At);
	n(
		jt,
		() => `
...
`
	...
	var Mt = a(jt, 2);
	(o(Mt, { kind: `hero`, name: `Mo & Krill`, ability: `Combo` }), t(At), t(w));
	var D = a(w, 2);
	r(D, 1, `hero paradox`);
	var Nt = i(D);
	n(
...
`
	...
	var Ft = a(Pt, 2);
	(o(Ft, { kind: `hero`, name: `Paradox`, ability: `Time Wall` }), t(O));
	var It = a(O, 2);
	r(It, 1, `ability kinetic-carbine`);
	var Lt = i(It);
	n(
		Lt,
		() => `
...
`
	...
	var Rt = a(Lt, 2);
	(o(Rt, { kind: `hero`, name: `Paradox`, ability: `Kinetic Carbine` }), t(It), t(D));
	var k = a(D, 2);
	r(k, 1, `hero pocket`);
	var zt = i(k);
	n(
...
`
	...
	var Ht = a(Vt, 2);
	(o(Ht, { kind: `hero`, name: `Pocket`, ability: `Affliction DPS` }), t(Bt), t(k));
	var A = a(k, 2);
	r(A, 1, `hero seven`);
	var Ut = i(A);
	n(
...
`
	...
	var Kt = a(Gt, 2);
	(o(Kt, { kind: `hero`, name: `Seven`, ability: `Power Surge` }), t(Wt), t(A));
	var j = a(A, 2);
	r(j, 1, `hero warden`);
	var qt = i(j);
	n(
...
`
	...
	var Jt = a(qt, 2);
	r(Jt, 1, `ability alchemical-flask`);
	var Yt = i(Jt);
	n(
		Yt,
		() => `
...
`
	...
	var Xt = a(Yt, 2),
		Zt = i(Xt),
		Qt = i(Zt);
	n(Qt, () => `Alchemical Flask damage increased from 48 to 55`);
	var $t = a(Qt, 2);
	(s($t, {
		kind: `hero`,
		name: `Warden`,
		...
		t(Xt));
	var en = a(Xt, 2);
	(o(en, { kind: `hero`, name: `Warden`, ability: `Alchemical Flask` }), t(Jt), t(j));
	var tn = a(j, 2);
	r(tn, 1, `hero yamato`);
	var nn = i(tn);
	n(
...
`
	...
	var an = a(rn, 2),
		on = i(an),
		sn = i(on);
	n(sn, () => `Crimson Slash cooldown reduced from 13s to 11s`);
	var cn = a(sn, 2);
	(s(cn, {
		kind: `hero`,
		name: `Yamato`,
		...
		t(an));
	var ln = a(an, 2);
	(o(ln, { kind: `hero`, name: `Yamato`, ability: `Crimson Slash` }), t(M));
	var N = a(M, 2);
	r(N, 1, `ability power-slash`);
	var un = i(N);
	n(
		un,
		() => `
...
`
	...
	var dn = a(un, 2);
	(o(dn, { kind: `hero`, name: `Yamato`, ability: `Power Slash` }), t(N));
	var P = a(N, 2);
	r(P, 1, `ability shadow-explosion`);
	var fn = i(P);
	n(
		fn,
		() => `
...
`
	...
	var pn = a(fn, 2),
		mn = i(pn),
		hn = i(mn);
	n(hn, () => `Shadow Explosion radius increased from 14m to 16m`);
	var gn = a(hn, 2);
	(s(gn, {
		kind: `hero`,
		name: `Yamato`,
		...
		t(pn));
	var _n = a(pn, 2);
	(o(_n, { kind: `hero`, name: `Yamato`, ability: `Shadow Explosion` }), t(P));
	var F = a(P, 2);
	r(F, 1, `ability shadow-transformation`);
	var vn = i(F);
	n(
		vn,
		() => `
...
`
	...
	var yn = a(vn, 2);
	(o(yn, { kind: `hero`, name: `Yamato`, ability: `Shadow Transformation` }), t(F));
	var bn = a(F, 2);
	r(bn, 1, `ability shadow-explosion`);
	var xn = i(bn);
	n(
		xn,
		() => `
...
`
	...
	var Sn = a(xn, 2);
	(o(Sn, { kind: `hero`, name: `Yamato`, ability: `Shadow Explosion` }), t(bn), t(tn));
	var Cn = a(tn, 2);
	n(
		Cn,
		() => `
...
`
	...
	var En = a(Tn, 2);
	(o(En, { kind: `item`, name: `Alchemical Fire`, ability: null }), t(I));
	var L = a(I, 2);
...
`
	...
	var On = a(Dn, 2);
	(o(On, { kind: `item`, name: `Crippling Headshot`, ability: null }), t(L));
	var R = a(L, 2);
	r(R, 1, `item decay`);
	var kn = i(R);
	n(
...
`
	...
	var An = a(kn, 2),
		jn = i(An),
		Mn = i(jn);
	n(Mn, () => `Cooldown reduced from 25s to 22s`);
	var Nn = a(Mn, 2);
	(s(Nn, {
		kind: `item`,
		name: `Decay`,
		...
		t(jn));
	var Pn = a(jn, 2);
	(n(Pn, () => `Cast range increased from 20m to 30m`, !0), t(Pn), t(An));
	var Fn = a(An, 2);
	(o(Fn, { kind: `item`, name: `Decay`, ability: null }), t(R));
	var z = a(R, 2);
...
`
	...
	var Ln = a(In, 2);
	(o(Ln, { kind: `item`, name: `Divine Barrier`, ability: null }), t(z));
	var B = a(z, 2);
	r(B, 1, `item diviner-s-kevlar`);
	var Rn = i(B);
	n(
		Rn,
		() => `
...
`
	...
	var zn = a(Rn, 2);
	(o(zn, { kind: `item`, name: `Diviner's Kevlar`, ability: null }), t(B));
	var V = a(B, 2);
	r(V, 1, `item enduring-speed`);
	var Bn = i(V);
	n(
		Bn,
		() => `
...
`
	...
	var Vn = a(Bn, 2);
	(o(Vn, { kind: `item`, name: `Enduring Speed`, ability: null }), t(V));
	var H = a(V, 2);
	r(H, 1, `item escalating-resilience`);
	var Hn = i(H);
	n(
		Hn,
		() => `
...
`
	...
	var Un = a(Hn, 2);
	(o(Un, { kind: `item`, name: `Escalating Resilience`, ability: null }), t(H));
	var U = a(H, 2);
...
`
	...
	var Gn = a(Wn, 2);
	(o(Gn, { kind: `item`, name: `Heroic Aura`, ability: null }), t(U));
	var W = a(U, 2);
...
`
	...
	var qn = a(Kn, 2),
		Jn = i(qn),
		Yn = i(Jn);
	n(Yn, () => `Cooldown reduced from 55s to 50s`);
	var Xn = a(Yn, 2);
	(s(Xn, {
		kind: `item`,
		name: `Knockdown`,
		...
		t(Jn));
	var Zn = a(Jn, 2);
	(n(Zn, () => `Now provides +200 Spirit Shield`, !0), t(Zn), t(qn));
	var Qn = a(qn, 2);
	(o(Qn, { kind: `item`, name: `Knockdown`, ability: null }), t(W));
	var G = a(W, 2);
	r(G, 1, `item lifestrike`);
	var $n = i(G);
	n(
		$n,
		() => `
...
`
	...
	var er = a($n, 2),
		tr = i(er);
	(n(tr, () => `Slow duration increased from 1s to 1.5s`, !0), t(tr));
	var nr = a(tr, 2),
		rr = i(nr);
	n(rr, () => `Cooldown reduced from 10s to 8s`);
	var ir = a(rr, 2);
	(s(ir, {
		kind: `item`,
		name: `Lifestrike`,
		...
		t(er));
	var ar = a(er, 2);
	(o(ar, { kind: `item`, name: `Lifestrike`, ability: null }), t(G));
	var K = a(G, 2);
	r(K, 1, `item melee-lifesteal`);
	var or = i(K);
	n(
		or,
		() => `
...
`
	...
	var sr = a(or, 2),
		cr = i(sr),
		lr = i(cr);
	n(lr, () => `Cooldown reduced from 10s to 8s`);
	var ur = a(lr, 2);
	(s(ur, {
		kind: `item`,
		...
		t(sr));
	var dr = a(sr, 2);
	(o(dr, { kind: `item`, name: `Melee Lifesteal`, ability: null }), t(K));
	var q = a(K, 2);
...
`
	...
	var pr = a(fr, 2);
	(o(pr, { kind: `item`, name: `Mystic Reverb`, ability: null }), t(q));
	var J = a(q, 2);
	r(J, 1, `item phantom-strike`);
	var mr = i(J);
	n(
		mr,
		() => `
...
`
	...
	var hr = a(mr, 2);
	(o(hr, { kind: `item`, name: `Phantom Strike`, ability: null }), t(J));
	var Y = a(J, 2);
	r(Y, 1, `item reactive-barrier`);
	var gr = i(Y);
	n(
		gr,
		() => `
...
`
	...
	var _r = a(gr, 2),
		vr = i(_r);
	(n(vr, () => `Barrier duration increased from 10s to 13s`, !0), t(vr));
	var yr = a(vr, 2),
		br = i(yr);
	n(br, () => `Cooldown reduced from 60s to 40s`);
	var xr = a(br, 2);
	(s(xr, {
		kind: `item`,
		...
		t(_r));
	var Sr = a(_r, 2);
	(o(Sr, { kind: `item`, name: `Reactive Barrier`, ability: null }), t(Y));
	var X = a(Y, 2);
	r(X, 1, `item restorative-locket`);
	var Cr = i(X);
	n(
		Cr,
		() => `
...
`
	...
	var wr = a(Cr, 2),
		Tr = i(wr);
	(n(Tr, () => `Max Stacks increased from 12 to 15`, !0), t(Tr));
	var Er = a(Tr, 2),
		Dr = i(Er);
	n(Dr, () => `Cooldown increased from 15s to 18s`);
	var Or = a(Dr, 2);
	(s(Or, {
		kind: `item`,
		...
		t(wr));
	var kr = a(wr, 2);
	(o(kr, { kind: `item`, name: `Restorative Locket`, ability: null }), t(X));
	var Z = a(X, 2);
	r(Z, 1, `item return-fire`);
	var Ar = i(Z);
	n(
		Ar,
		() => `
...
`
	...
	var jr = a(Ar, 2);
	(o(jr, { kind: `item`, name: `Return Fire`, ability: null }), t(Z));
	var Q = a(Z, 2);
	r(Q, 1, `item shadow-weave`);
	var Mr = i(Q);
	n(
		Mr,
		() => `
...
`
	...
	var Nr = a(Mr, 2);
	(o(Nr, { kind: `item`, name: `Shadow Weave`, ability: null }), t(Q));
	var Pr = a(Q, 2);
	r(Pr, 1, `item slowing-hex`);
	var Fr = i(Pr);
	n(
		Fr,
		() => `
...
`
	...
	var Ir = a(Fr, 2),
		Lr = i(Ir),
		Rr = i(Lr);
	n(Rr, () => `Cooldown reduced from 30s to 25s`);
	var zr = a(Rr, 2);
	(s(zr, {
		kind: `item`,
		name: `Slowing Hex`,
		...
		t(Ir));
	var Br = a(Ir, 2);
	(o(Br, { kind: `item`, name: `Slowing Hex`, ability: null }), t(Pr));
	var Vr = a(Pr, 2);
	r(Vr, 1, `item spirit-strike`);
	var Hr = i(Vr);
	n(
		Hr,
		() => `
...
`
	...
	var Ur = a(Hr, 2);
	(o(Ur, { kind: `item`, name: `Spirit Strike`, ability: null }), t(Vr));
	var Wr = a(Vr, 2);
	r(Wr, 1, `item suppressor`);
	var Gr = i(Wr);
	n(
		Gr,
		() => `
...
`
	...
	var Kr = a(Gr, 2);
	(o(Kr, { kind: `item`, name: `Suppressor`, ability: null }), t(Wr));
	var qr = a(Wr, 2);
	r(qr, 1, `item unstoppable`);
	var Jr = i(qr);
	n(
		Jr,
		() => `
...
`
	...
	var Yr = a(Jr, 2);
	(o(Yr, { kind: `item`, name: `Unstoppable`, ability: null }), t(qr));
	var $ = a(qr, 2);
...
`
	...
	var Zr = a(Xr, 2);
	(o(Zr, { kind: `item`, name: `Vampiric Burst`, ability: null }), t($));
	var Qr = a($, 2);
	r(Qr, 1, `item warp-stone`);
	var $r = i(Qr);
	n(
		$r,
		() => `
...
`
	...
	var ei = a($r, 2);
	(o(ei, { kind: `item`, name: `Warp Stone`, ability: null }), t(Qr), ee(e, c));
}
export { l as default, ie as metadata, oe as readingManifest, ae as toc };
