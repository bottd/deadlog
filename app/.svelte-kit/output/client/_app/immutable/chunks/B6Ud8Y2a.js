...
var l = {
	...
	u = [
		...
		{ level: 3, title: `Chain Gang`, id: `chain-gang` },
		...
		{ level: 3, title: `Card Trick Heart`, id: `card-trick-heart` },
	...
	re = e(
		`<!> <!> <div><!> <div><!> <!></div> <div><!> <!></div></div> <div><!> <div><!> <!></div> <div><!> <!></div></div> <div><!> <div><!> <!></div> <div><!> <!></div></div> <div><!> <div><!> <!></div> <div><!> <ul><li><!> <!></li> <li></li></ul> <!></div></div> <div><!> <div><!> <!></div></div> <div><!> <div><!> <!></div></div> <!> <div><!> <div><!> <!></div> <div><!> <!></div></div> <div><!> <div><!> <!></div></div> <div><!> <div><!> <ul><li><!> <!></li></ul> <!></div></div> <div><!> <div><!> <!></div></div> <div><!> <div><!> <ul><li><!> <!></li> <li></li></ul> <!></div></div> <div><!> <div><!> <!></div> <div><!> <!></div></div>`,
		1
	);
function f(e) {
	var c = re(),
...
`
	...
	var ae = a(ie, 2);
	(o(ae, { kind: `hero`, name: `Apollo`, ability: `Riposte` }), t(p));
	var m = a(p, 2);
	r(m, 1, `ability itani-lo-sahn`);
	var oe = i(m);
	n(
		oe,
		() => `
...
`
	...
	var se = a(oe, 2);
	(o(se, { kind: `hero`, name: `Apollo`, ability: `Itani Lo Sahn` }), t(m), t(d));
	var h = a(d, 2);
	r(h, 1, `hero billy`);
	var ce = i(h);
	n(
...
`
	...
	var ue = a(le, 2);
	(o(ue, { kind: `hero`, name: `Billy`, ability: `Rising Ram` }), t(g));
	var _ = a(g, 2);
	r(_, 1, `ability chain-gang`);
	var de = i(_);
	n(
		de,
		() => `
...
`
	...
	var fe = a(de, 2);
	(o(fe, { kind: `hero`, name: `Billy`, ability: `Chain Gang` }), t(_), t(h));
	var v = a(h, 2);
	r(v, 1, `hero doorman`);
	var pe = i(v);
	n(
...
`
	...
	var me = a(b, 2);
	(o(me, { kind: `hero`, name: `Doorman`, ability: `Doorway` }), t(y));
	var x = a(y, 2);
	r(x, 1, `ability luggage-cart`);
	var he = i(x);
	n(
		he,
		() => `
...
`
	...
	var ge = a(he, 2);
	(o(ge, { kind: `hero`, name: `Doorman`, ability: `Luggage Cart` }), t(x), t(v));
	var S = a(v, 2);
	r(S, 1, `hero drifter`);
	var _e = i(S);
	n(
...
`
	...
	var ye = a(ve, 2);
	(o(ye, { kind: `hero`, name: `Drifter`, ability: `Rend` }), t(C));
	var w = a(C, 2);
	r(w, 1, `ability stalker-s-mark`);
	var be = i(w);
	n(
		be,
		() => `
...
`
	...
	var T = a(be, 2),
		E = i(T),
		xe = i(E);
	n(xe, () => `Stalker&#x27;s Mark cooldown increased from 24s to 26s`);
	var Se = a(xe, 2);
	(s(Se, {
		kind: `hero`,
		name: `Drifter`,
		...
		t(E));
	var D = a(E, 2);
	(n(D, () => `Stalker&#x27;s Mark T2 reduced from -12s Cooldown to -10s`, !0),
		t(D),
		t(T));
	var Ce = a(T, 2);
	(o(Ce, { kind: `hero`, name: `Drifter`, ability: `Stalker's Mark` }), t(w), t(S));
	var O = a(S, 2);
	r(O, 1, `hero holliday`);
	var k = i(O);
	n(
...
`
	...
	var we = a(j, 2);
	(o(we, { kind: `hero`, name: `Holliday`, ability: `Powder Keg` }), t(A), t(O));
	var M = a(O, 2);
	r(M, 1, `hero ivy`);
	var N = i(M);
	n(
...
`
	...
	var Te = a(F, 2);
	(o(Te, { kind: `hero`, name: `Ivy`, ability: `Stone Form` }), t(P), t(M));
	var Ee = a(M, 2);
	n(
		Ee,
		() => `
...
`
	...
	var Oe = a(De, 2);
	(o(Oe, { kind: `hero`, name: `McGinnis`, ability: `Mini Turrets` }), t(R));
	var z = a(R, 2);
	r(z, 1, `ability medicinal-specter`);
	var ke = i(z);
	n(
		ke,
		() => `
...
`
	...
	var Ae = a(ke, 2);
	(o(Ae, { kind: `hero`, name: `McGinnis`, ability: `Medicinal Specter` }), t(z), t(I));
	var B = a(I, 2);
	r(B, 1, `hero paige`);
	var je = i(B);
	n(
...
`
	...
	var Ne = a(Me, 2);
	(o(Ne, { kind: `hero`, name: `Paige`, ability: `Plot Armor` }), t(V), t(B));
	var H = a(B, 2);
	r(H, 1, `hero seven`);
	var Pe = i(H);
	n(
...
`
	...
	var W = a(Fe, 2),
		Ie = i(W),
		Le = i(Ie);
	n(Le, () => `Lightning Ball T3 radius increased from +1.5m to +1.75m`);
	var Re = a(Le, 2);
	(s(Re, {
		kind: `hero`,
		name: `Seven`,
		...
		t(W));
	var ze = a(W, 2);
	(o(ze, { kind: `hero`, name: `Seven`, ability: `Lightning Ball` }), t(U), t(H));
	var G = a(H, 2);
	r(G, 1, `hero vindicta`);
	var Be = i(G);
	n(
...
`
	...
	var He = a(Ve, 2);
	(o(He, { kind: `hero`, name: `Vindicta`, ability: `Stake` }), t(K), t(G));
	var q = a(G, 2);
	r(q, 1, `hero vyper`);
	var Ue = i(q);
	n(
...
`
	...
	var Y = a(We, 2),
		X = i(Y),
		Ge = i(X);
	n(Ge, () => `Petrifying Bola radius increased from 8m to 12m`);
	var Ke = a(Ge, 2);
	(s(Ke, {
		kind: `hero`,
		name: `Vyper`,
		...
		t(X));
	var qe = a(X, 2);
	(n(qe, () => `Petrifying Bola petrify duration increased from 2s to 2.2s`, !0),
		t(qe),
		t(Y));
	var Je = a(Y, 2);
	(o(Je, { kind: `hero`, name: `Vyper`, ability: `Petrifying Bola` }), t(J), t(q));
	var Z = a(q, 2);
	r(Z, 1, `hero wraith`);
	var Ye = i(Z);
	n(
...
`
	...
	var Q = a(Ye, 2);
	r(Q, 1, `ability card-trick-heart`);
	var Xe = i(Q);
	n(
		Xe,
		() => `
...
`
	...
	var Ze = a(Xe, 2);
	(o(Ze, { kind: `hero`, name: `Wraith`, ability: `Card Trick Heart` }), t(Q));
	var $ = a(Q, 2);
	r($, 1, `ability full-auto`);
	var Qe = i($);
	n(
		Qe,
		() => `
...
`
	...
	var $e = a(Qe, 2);
	(o($e, { kind: `hero`, name: `Wraith`, ability: `Full Auto` }), t($), t(Z), ee(e, c));
}
