import { s as __commonJSMin } from './chunks/index-server.js';
import {
	S as once,
	_ as text_encoder,
	a as split_remote_key,
	f as get_status,
	g as get_relative_path,
	h as base64_encode,
	i as parse_remote_arg,
	n as TRAILING_SLASH_PARAM,
	o as stringify$1,
	p as normalize_error,
	r as create_remote_key,
	t as INVALIDATED_PARAM,
	v as stringify,
	x as noop
...
import {
	...
	T as parseString,
	_ as negotiate,
	a as get_global_name,
	b as deserialize_binary_form,
	c as handle_fatal_error,
	d as redirect_response,
	f as serialize_uses,
	g as is_form_content_type,
	h as get_set_cookies,
	i as format_server_error,
	l as has_prerendered_path,
	m as escape_html,
	o as get_node_type,
	p as static_error_page,
	r as create_replacer,
	s as handle_error_and_jsonify,
	t as clarify_devalue_error,
	u as method_not_allowed
...
import {
	...
	f as set_public_env,
	l as set_read_implementation,
	n as options,
	s as read_implementation,
	t as get_hooks,
	u as public_env
} from './chunks/internal.js';
import {
	S as compact,
	_ as add_resolution_suffix,
	b as strip_data_suffix,
	d as disable_search,
	f as make_trackable,
	g as add_data_suffix,
	h as noop_span,
	i as validate_page_server_exports,
	m as resolve,
	n as validate_layout_server_exports,
	o as find_route,
	p as normalize_path,
	r as validate_page_exports,
	s as hash,
	t as validate_layout_exports,
	u as decode_pathname,
	v as has_data_suffix,
	x as strip_resolution_suffix,
	y as has_resolution_suffix
} from './chunks/exports.js';
import { A as readable, j as writable } from './chunks/server2.js';
...
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/utils/promise.js
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/constants.js
var NULL_BODY_STATUS = [101, 103, 204, 205, 304];
var IN_WEBCONTAINER = !!globalThis.process?.versions?.webcontainer;
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/utils/misc.js
var s = JSON.stringify;
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/endpoint.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/telemetry/record_span.js
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/page/actions.js
...
function is_action_json_request(event) {
	return (
		negotiate(event.request.headers.get('accept') ?? '*/*', [
			'application/json',
			'text/html'
		]) === 'application/json' && event.request.method === 'POST'
	);
}
/**
 * @param {RequestEvent} event
...
function check_incorrect_fail_use(error) {
	return error instanceof ActionFailure
		? /* @__PURE__ */ new Error('Cannot "throw fail()". Use "return fail()"')
		: error;
}
/**
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/utils/streaming.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/page/data_serializer.js
/**
	...
	return {
		add_node(i, node) {
			try {
				...
				strings[i] =
					`{"type":"data","data":${stringify(node.data, reducers)},"uses":${JSON.stringify(serialize_uses(node))}${node.slash ? `,"slash":${JSON.stringify(node.slash)}` : ''}}`;
			} catch (e) {
				e.path = 'data' + e.path;
				throw new Error(clarify_devalue_error(event, e), { cause: e });
			}
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/page/load_data.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/page/serialize_data.js
/**
...
function serialize_data(fetched, filter, prerendering = false) {
	...
	if (!prerendering && fetched.method === 'GET' && cache_control && !varyAny) {
		const match =
			/s-maxage=(\d+)/g.exec(cache_control) ?? /max-age=(\d+)/g.exec(cache_control);
		if (match) {
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/page/crypto.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/page/csp.js
...
var BaseProvider = class {
	...
	get_header(is_meta = false) {
		...
		for (const key in directives) {
			if (
				is_meta &&
				(key === 'frame-ancestors' || key === 'report-uri' || key === 'sandbox')
			)
				continue;
...
var Csp = class {
	...
	get script_needs_hash() {
		return (
			this.csp_provider.script_needs_hash || this.report_only_provider.script_needs_hash
		);
	}
	get script_needs_nonce() {
		return (
			this.csp_provider.script_needs_nonce || this.report_only_provider.script_needs_nonce
		);
	}
	get style_needs_nonce() {
		return (
			this.csp_provider.style_needs_nonce || this.report_only_provider.style_needs_nonce
		);
	}
	/** @param {string} content */
	add_script(content) {
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/page/server_routing.js
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/remote.js
...
async function handle_remote_call_internal(event, state, options, manifest, id) {
	...
	try {
			...
			case 'form': {
				...
				if (!is_form_content_type(event.request))
					throw new SvelteKitError(
						415,
						'Unsupported Media Type',
						`\`form\` functions expect form-encoded data — received ${event.request.headers.get('content-type')}`
					);
				const {
					data: input,
					meta,
		...
		if (error instanceof Redirect) {
			const data = await collect_remote_data(
...
function get_remote_id(url) {
	return (
		url.pathname.startsWith(`${base}/_app/remote/`) &&
		url.pathname.replace(`${base}/_app/remote/`, '')
	);
}
/**
 * @param {URL} url
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/page/render.js
var updated = {
	...readable(false),
	check: () => false
};
...
async function render_response({
	...
	if (!state.prerendering?.fallback) {
		base$1 =
			(event.isDataRequest ? add_data_suffix(event.url.pathname) : event.url.pathname)
				.slice(base.length)
				.split('/')
				.slice(2)
				.map(() => '..')
	...
	if (page_config.csr && client) {
		...
		const serialized_data =
			Object.keys(remote_data).length > 0
				? `${global}.data = ${uneval(remote_data, create_replacer(options.hooks.transport))};\n\n\t\t\t\t\t\t`
				: '';
		...
		if (options.service_worker) {
			...
			if (options.service_worker_options != null)
				opts = `, ${s({ ...options.service_worker_options })}`;
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/utils/page_nodes.js
var PageNodes = class {
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/page/respond_with_error.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/page/index.js
...
async function render_page(
	...
	if (is_action_json_request(event))
		return handle_action_json_request(
			...
			event_state,
			options,
			(await manifest._.nodes[page.leaf]())?.server
		);
	try {
		...
		return await render_response({
			...
			fetched,
			data_serializer: !ssr
				? server_data_serializer(event, event_state, options)
				: data_serializer,
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/data/index.js
/**
 * @param {import('@sveltejs/kit').RequestEvent} event
 * @param {import('types').RequestState} event_state
	...
	try {
		...
		if (error instanceof Redirect) return redirect_json_response(error);
			...
			return json_response(
				await handle_error_and_jsonify(event, event_state, options, error),
				500
			);
	}
}
 ...
 */
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/cookie.js
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/fetch.js
/**
 * @param {{
 *   event: import('@sveltejs/kit').RequestEvent;
 *   options: import('types').SSROptions;
		...
		return options.hooks.handleFetch({
			...
			fetch: async (info, init) => {
				...
				if (info !== original_request) {
					...
					credentials =
						(info instanceof Request ? info.credentials : init?.credentials) ??
						'same-origin';
				}
				if (
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/env_module.js
/** @type {string} */
var payload;
/** @type {string} */
var etag;
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/respond.js
...
async function internal_respond(request, options, manifest, state) {
	...
	if (is_route_resolution_request)
		...
		url.pathname =
			strip_data_suffix(url.pathname) +
				(url.searchParams.get('x-sveltekit-trailing-slash') === '1' ? '/' : '') || '/';
	...
	/** @type {Record<string, string>} */
	const headers = {};
	const { cookies, new_cookies, get_cookie_header, set_internal, set_trailing_slash } =
	...
	if (resolved_path === `/_app/env.js` || resolved_path === `/_app/env.script.js`)
			...
			if (route) {
				...
				if (is_data_request)
					...
					if (!page_nodes)
						...
						if ((await manifest._.nodes[route.page.leaf]())?.server?.actions)
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/utils/env.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/index.js
