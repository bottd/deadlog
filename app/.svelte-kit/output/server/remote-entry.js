import {
	...
	s as stringify_remote_arg,
	x as noop,
	y as parse
} from './chunks/shared.js';
import { r as base, t as app_dir } from './chunks/server.js';
import {
	C as set_nested_value,
	D as MUTATIVE_METHODS,
	S as normalize_issue,
	s as handle_error_and_jsonify,
	v as create_field_proxy,
	x as flatten_issues,
	y as deep_set
} from './chunks/utils.js';
import { n as prerendering } from './chunks/internal2.js';
import { error, json } from '@sveltejs/kit';
import { HttpError, SvelteKitError, ValidationError } from '@sveltejs/kit/internal';
import { get_request_store, with_request_store } from '@sveltejs/kit/internal/server';
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/app/server/remote/shared.js
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/app/server/remote/command.js
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/app/server/remote/form.js
		...
		if (key == void 0)
			Object.defineProperty(instance, 'for', {
				...
				value: (key) => {
					...
					let instance = (state.remote.forms ??= /* @__PURE__ */ new Map()).get(
						cache_key
					);
					if (!instance) {
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/app/server/remote/prerender.js
	...
	const wrapper = (arg) => {
		...
		const promise = get_response(__, payload, state, async () => {
			...
			if (state.prerendering?.remote_responses.has(url))
				return state.prerendering.remote_responses.get(url);
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/utils/shared-iterator.js
/**
...
var SharedIterator = class {
	...
	subscribe(options) {
		...
		const subscriber = {
			...
			pending_error:
				this.#closed && this.#terminal_error !== void 0
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/app/server/remote/query.js
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/app/server/remote/requested.js
