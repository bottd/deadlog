...
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/constants.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/form-utils.js
	...
	return new Proxy(target, {
		get(target, prop) {
			...
			if (prop === 'issues' || prop === 'allIssues') {
				const issues_func = () => {
					const all_issues = get_issues(path, prop === 'allIssues')[
						key === '' ? '$' : key
					];
					if (prop === 'allIssues')
			...
			if (prop === 'as') {
				...
				const as_func = (type, input_value) => {
					...
					const base_props = {
						name:
							get_type_prefix(type, is_array, input_value) + key + (is_array ? '[]' : ''),
						get 'aria-invalid'() {
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/utils/http.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/utils/escape.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/@sveltejs+kit@2.70.3_@sveltejs+vite-plugin-svelte@7.3.0_svelte@5.57.0_@typescript-eslin_d34b0b60129670dccbfe83ef3c3382f5/node_modules/@sveltejs/kit/src/runtime/server/utils.js
...
export {
	...
	MUTATIVE_METHODS as D,
	ENDPOINT_METHODS as E,
	PAGE_METHODS as O,
	normalize_issue as S,
	parseString as T,
	negotiate as _,
	get_global_name as a,
	deserialize_binary_form as b,
	handle_fatal_error as c,
	redirect_response as d,
	serialize_uses as f,
	is_form_content_type as g,
	get_set_cookies as h,
	format_server_error as i,
	SVELTE_KIT_ASSETS as k,
	has_prerendered_path as l,
	escape_html as m,
	count_non_ssi_comments as n,
	get_node_type as o,
	static_error_page as p,
	create_replacer as r,
	handle_error_and_jsonify as s,
	clarify_devalue_error as t,
	method_not_allowed as u,
	create_field_proxy as v,
	throw_on_old_property_access as w,
	flatten_issues as x,
	deep_set as y
};
