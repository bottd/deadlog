...
import {
	$ as init_operations,
	At as hydration_mismatch,
	B as component_root,
	Bt as define_property,
	C as setContext,
	Ct as hydrate_next,
	Dt as set_hydrate_node,
	Et as next,
	F as set_active_effect,
	Ft as EFFECT_PRESERVED,
	G as pause_effect,
	I as set_active_reaction,
	It as EFFECT_TRANSPARENT,
	J as clear_text_content,
	K as render_effect,
	L as untrack,
	Lt as LEGACY_PROPS,
	M as active_effect,
	Mt as svelte_boundary_reset_noop,
	N as active_reaction,
	Ot as set_hydrating,
	P as get,
	Pt as HYDRATION_ERROR,
	Q as get_next_sibling,
	R as block,
	Tt as hydrating,
	U as effect_tracking,
	V as destroy_effect,
	W as move_effect,
	X as create_text,
	...
	a as derived,
	at as Batch,
	ct as without_reactive_context,
	dt as component_context,
	et as increment,
	ft as mark_as_component,
	ht as set_component_context,
	it as source,
	k as is_passive_event,
	kt as skip_nodes,
	lt as defer_effect,
	mt as push,
	nt as mutable_source,
	ot as current_batch,
	pt as pop,
	q as invoke_error_boundary,
	rt as set,
	st as flushSync,
	tt as internal_set,
	u as render,
	ut as queue_micro_task,
	vt as async_mode_flag,
	wt as hydrate_node,
	xt as svelte_boundary_reset_onerror,
	yt as hydration_failed,
	z as branch,
	zt as array_from
} from './server2.js';
/**
...
//#endregion
//#region ../node_modules/.pnpm/svelte@5.57.0_@typescript-eslint+types@8.70.0/node_modules/svelte/src/internal/client/dom/elements/events.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/svelte@5.57.0_@typescript-eslint+types@8.70.0/node_modules/svelte/src/internal/client/dom/template.js
...
function append(anchor, dom) {
	if (hydrating) {
		var effect = active_effect;
		if ((effect.f & 32768) === 0 || effect.nodes.end === null)
...
//#endregion
//#region ../node_modules/.pnpm/svelte@5.57.0_@typescript-eslint+types@8.70.0/node_modules/svelte/src/reactivity/create-subscriber.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/svelte@5.57.0_@typescript-eslint+types@8.70.0/node_modules/svelte/src/internal/client/dom/blocks/boundary.js
...
function hydrate(component, options) {
	...
	try {
		...
		while (anchor && (anchor.nodeType !== 8 || anchor.data !== '['))
	...
	var unmount = component_root(() => {
		...
		boundary(
			...
			(anchor_node) => {
				...
				if (hydrating) {
					/** @type {Effect & { nodes: EffectNodes }} */ active_effect.nodes.end =
						hydrate_node;
					if (
						hydrate_node === null ||
...
//#endregion
//#region ../node_modules/.pnpm/svelte@5.57.0_@typescript-eslint+types@8.70.0/node_modules/svelte/src/legacy/legacy-client.js
...
//#endregion
//#region ../node_modules/.pnpm/svelte@5.57.0_@typescript-eslint+types@8.70.0/node_modules/svelte/src/legacy/legacy-server.js
...
var error_template_default = ({ status, message }) =>
	'<!doctype html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<title>' +
	message +
...
export {
	...
	options as n,
	on as o,
	createClassComponent as r,
	read_implementation as s,
	get_hooks as t,
	public_env as u
};
