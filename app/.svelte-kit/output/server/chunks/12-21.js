...
//#region changelogs/2024/12-21.mg?embed=0
function _2_21_mg$2($$renderer) {
	SectionPreview($$renderer, {
		type: 'hero',
		names: ['Infernus', 'Mirage', 'Vindicta', 'Warden', 'Yamato']
	});
}
//#endregion
//#region changelogs/2024/12-21.mg?embed=1
function _2_21_mg$1($$renderer) {
	SectionPreview($$renderer, {
		type: 'item',
...
//#endregion
//#region changelogs/2024/12-21.mg
var metadata = {
...
function _2_21_mg($$renderer) {
	...
	$$renderer.push(
		`<!----></li> <li>${html('Assassinate bonus damage reduced from 120 to 100')}</li></ul> `
	);
	MogEntityContext($$renderer, {
		kind: 'hero',
		name: 'Vindicta',
...
//#endregion
export { _2_21_mg as default, metadata, readingManifest, toc };
