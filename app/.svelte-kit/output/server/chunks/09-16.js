...
//#region changelogs/2026/09-16.mg?embed=0
function _9_16_mg$2($$renderer) {
...
//#endregion
//#region changelogs/2026/09-16.mg?embed=1
function _9_16_mg$1($$renderer) {
	SectionPreview($$renderer, {
		type: 'item',
		names: [
...
//#endregion
//#region changelogs/2026/09-16.mg
var metadata = {
	...
	related: [
		{
			...
			record: {
				...
				candidates: [
					709540378, 865846625, 865958998, 1252627263, 1770441818, 1798666702, 1813726886,
					2059712766, 2121044373, 2142980412, 2226497419, 2462046703, 2678489038,
					2820116164, 2947183272, 3074274290, 3144988365, 3294954488, 3491236900,
					3585132399, 3696726732, 3919289022
				],
				items: [
					{
						id: 1252627263,
...
function _9_16_mg($$renderer) {
	...
	$$renderer.push(
		`<!----></li> <li>${html('Shining Wonder T3 Max Bounces reduced from +8 to +6')}</li></ul> `
	);
	MogEntityContext($$renderer, {
		kind: 'hero',
		name: 'Celeste',
	...
	$$renderer.push(
		`<!----></li> <li>${html('Stone Form T1 max health heal reduced from 7% to 6%')}</li></ul> `
	);
	MogEntityContext($$renderer, {
		kind: 'hero',
		name: 'Ivy',
	...
	$$renderer.push(
		`<!----></li> <li>${html('Cast range increased from 20m to 25m')}</li></ul> `
	);
	MogEntityContext($$renderer, {
		kind: 'item',
		name: 'Focus Lens',
...
//#endregion
export { _9_16_mg as default, metadata, readingManifest, toc };
