...
function array_index_cut(keys) {
	for (var i = keys.length - 1; i >= 0; i--)
		if (is_valid_array_index_string(keys[i])) break;
	return i + 1;
}
/**
...
export {
	...
	stringify_key as c,
	MAX_ARRAY_INDEX as d,
	get_type as i,
	stringify_string as l,
	DevalueError as n,
	is_valid_array_index as o,
	enumerable_symbols as r,
	is_valid_array_len as s,
	uneval as t,
	valid_array_indices as u
};
