import * as server from '../entries/pages/hero/_slug_/_page.server.ts.js';

export const index = 6;
let component_cache;
export const component = async () =>
	(component_cache ??= (await import('../entries/pages/hero/_slug_/_page.svelte.js'))
		.default);
export { server };
export const server_id = 'src/routes/hero/[slug]/+page.server.ts';
export const imports = [
	'_app/immutable/nodes/6.CpiIyeAV.js',
