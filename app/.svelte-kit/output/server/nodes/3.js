import * as server from '../entries/pages/ability/_slug_/_page.server.ts.js';

export const index = 3;
let component_cache;
export const component = async () =>
	(component_cache ??= (await import('../entries/pages/ability/_slug_/_page.svelte.js'))
		.default);
export { server };
export const server_id = 'src/routes/ability/[slug]/+page.server.ts';
export const imports = [
	'_app/immutable/nodes/3.BCJnjewc.js',
